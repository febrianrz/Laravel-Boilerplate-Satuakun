...
namespace App\Altcore\Commands;
...
class MakeApiCommand extends Command
{
    ...
    {
        $path = 'seeders/DatabaseSeeder.php';
        ...
        if (!$this->option('pretend')) {
            ...
            $this->comment('New Seeder has been appended to <info>database/seeders/DatabaseSeeder.php</info>');
        } else {
